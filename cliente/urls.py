...
urlpatterns = [
    ...
    path("pedidospendientes/<int:pedido_id>/editar/", views.editar_pedido_pendiente,
         name="editar_pedido_pendiente"),
    path("pedidospendientes/<int:pedido_id>/eliminar/", views.eliminar_pedido_pendiente,
         name="eliminar_pedido_pendiente"),
